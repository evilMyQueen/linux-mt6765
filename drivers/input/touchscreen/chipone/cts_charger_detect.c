...
static int cts_init_charger_detect(struct chipone_ts_data *cts_data)
{
    struct cts_charger_detect_data *cd_data;
    int ret = 0;
...
static int cts_deinit_charger_detect(struct chipone_ts_data *cts_data)
{
    struct cts_charger_detect_data *cd_data;
    int ret;
...
static int cts_is_charger_attached(struct chipone_ts_data *cts_data, bool *attached)
{
    struct cts_charger_detect_data *cd_data;
    int ret;
...
static int cts_start_charger_detect(struct chipone_ts_data *cts_data)
{
    struct cts_charger_detect_data *cd_data;
...
static int cts_stop_charger_detect(struct chipone_ts_data *cts_data)
{
    struct cts_charger_detect_data *cd_data;
