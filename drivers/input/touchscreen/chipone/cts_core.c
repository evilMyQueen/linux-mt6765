...
static const struct cts_sfctrl icnl9911_sfctrl = {
    .reg_base = 0x34000,
...
static const struct cts_sfctrl icnl9911s_sfctrl = {
    .reg_base = 0x34000,
...
static const struct cts_sfctrl icnl9911c_sfctrl = {
    .reg_base = 0x34000,
    .xchg_sram_base = (64 - 1) * 1024,
    .xchg_sram_size = 1024, /* For non firmware programming */
    .ops = &cts_sfctrlv2_ops
...
static const char *cts_work_mode2str(enum cts_work_mode work_mode)
{
...
static int cts_enable_fw_log_redirect(struct cts_device *cts_dev)
{
    int ret;
...
static int cts_disable_fw_log_redirect(struct cts_device *cts_dev)
{
    int ret;
...
static int cts_fw_log_show_finish(struct cts_device *cts_dev)
{
    int ret;
